---
layout: post
title: "Why Python and I are going through a divorce"
---
...
## Readability
This is probably the biggest thing that makes Python a nightmare for me. The code is basically spahgetti. Who thought that tabs instead of curly braces is a good idea? Having functionality be determined by code formatting is preposterous. It makes seeing where functions end and where if statements begin.
